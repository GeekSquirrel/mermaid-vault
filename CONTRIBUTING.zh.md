...
- **分支管理**：
  - 主仓库管理项目根目录及 `mermaid-vault-backend/` 后端代码。
...
- **后端代码变更**：
  - 直接在 `mermaid-vault-backend/` 下进行修改，并在主仓库根目录下提交。
- **Git 提交信息规范**：
...
- 后端文档：`mermaid-vault-backend/README.md`（英文）↔ `mermaid-vault-backend/README.zh.md`（中文）
